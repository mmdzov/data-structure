**برای کامل تر کردن این ریپو از شما دعوت میکنم. همچنین درجهت حمایت می توانید به این ریپو ستاره بدید و آن را fork کنید**
...
- [Stacks](https://github.com/mmdzov/data-structure/blob/main/src/3.Stacks/FA-README.md)