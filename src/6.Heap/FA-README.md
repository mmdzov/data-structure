...
- دارای پیچیدگی زمانی O(log n) برای درج و حذف عناصر هست که برای مجموعه داده های بزرگ کارآمد می باشد
- می توان بعنوان min heap یا max heap پیاده سازی کرد که برای انواع مختلف برنامه ها مانند priority queue یا الگوریتم های مرتب سازی انعطاف پذیر می باشد.
- می توان بصورت پویا درج و حذف عناصر را انجام داد و برای برنامه هایی که نیاز به درج و حذف عناصر در زمان واقعی دارند مناسب می باشد.
- ساختار ساده ای دارد و دارای درخت دودویی کامل هست که برای درک و پیاده سازی آسان می باشد.
- دارای یک ساختار پایدار می باشد به این معنی که عناصر به ترتیب اولویت پردازش می شوند و برای کاربرد های بلادرنگ مانند متعادل سازی بار ، کاربردهای پزشکی و تحلیل بازار سهام مناسب می باشد.
- می تواند برای مدیریت حجم بسیاری از داده ها مقیاس شود و برای برنامه های داده های بزرگ مانند مرتب سازی خارجی و فشرده سازی فایل مناسب می باشد.
- از نظر حافظه کارآمد می باشد زیرا فقط عناصری که برای پردازش ضروری هستند ذخیره می شوند و برای سیستم های تعبیه شده و دستگاه هایی با حافظه محدود مناسب می باشد.
- می تواند در محل پیاده سازی شود بدون نیاز به حافظه اضافی، برای برنامه هایی با محدود حافظه کارآمد می باشد.
- می تواند موازی باشد و به چندین پردازنده اجازه می دهد روی یک ساختار داده کار کنند درنهایت برای سیستم های چند هسته ای و محاسبات ، با کارایی بالا مناسب است.


# معایب

- برای مجموعه داده های کوچک مناسب نمی باشد 
- پیاده سازی پیچیده
- مدیریت حافظه در heap memory پیچیده تر است زیرا در سطح جهانی استفاده می شود.
- پیچیدگی زمانی برای جستجوی یک عنصر O(n) است.